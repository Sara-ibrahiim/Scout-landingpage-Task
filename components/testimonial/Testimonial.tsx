...
const Testimonial = () => {
  return (
    <section
      id="docs"
      className="scroll-mt-24 px-6 py-16 lg:p-[120px] text-white border-y border-white/10"
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[120px_1fr_120px] border border-[#1F1F1F]/60 rounded-xl overflow-hidden">
        {/* Left column */}
        <div className="hidden lg:grid grid-rows-3 border-r border-[#1F1F1F]/60">
        ...
        {/* Center content */}
        <div className="flex flex-col items-center justify-center px-6 lg:px-16 py-6 text-center">
          <p className="font-inter font-medium mx-4 lg:mx-12 text-lg sm:text-xl lg:text-2xl lg:text-[32px] leading-relaxed lg:leading-[42px] tracking-tight max-w-xl">
        ...
        {/* Right column */}
        <div className="hidden lg:grid grid-rows-3 border-l border-[#1F1F1F]/60">
          <div className="flex items-center justify-center border-b border-[#1F1F1F]/60 h-[120px]">
