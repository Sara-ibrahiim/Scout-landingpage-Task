  ...
  return (
    <section className="w-full m-auto rounded-xl">
      ...
      <div className="grid grid-cols-12 gap-6 max-w-6xl mx-auto">
        <div className="col-span-12 md:col-span-4 bg-[radial-gradient(50%_50%_at_50%_50%,rgba(27,27,27,0)_0%,rgba(27,27,27,0)_49.48%),radial-gradient(50%_50%_at_50%_50%,rgba(12,207,113,0.1)_0%,rgba(0,0,0,0)_100%)] rounded-xl p-6 flex flex-col border-0 md:border md:border-[rgba(255,255,255,0.06)] mx-auto">
          <span className="text-green-400 text-sm font-semibold mb-3">
            HOBBY
          </span>
        ...
        <div className="col-span-12 md:col-span-4 backdrop-blur-[30px] bg-[radial-gradient(50%_50%_at_50%_50%,rgba(27,27,27,0)_0%,#1B1B1B_49.48%),radial-gradient(50%_50%_at_50%_50%,rgba(195,140,245,0.2)_0%,rgba(26,26,26,0.2)_100%)] rounded-xl p-6 flex flex-col relative border-0 md:border md:border-[rgba(255,255,255,0.06)] mx-auto">
          ...
          <span className="text-purple-400 text-sm font-semibold mb-3">
            PRO
          </span>
        ...
        <div className="col-span-12 md:col-span-4 bg-[#0F0F0F] bg-[radial-gradient(50%_50%_at_50%_50%,rgba(92,124,230,0.15)_0%,rgba(0,0,0,0)_100%)] rounded-xl p-6 flex flex-col border-0 md:border md:border-[rgba(255,255,255,0.06)] mx-auto">
